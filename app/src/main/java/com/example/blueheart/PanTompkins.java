...
public class PanTompkins extends LmeFilter
{
	...
	public static class QRS
	{
		...
		public float				qAmplitude;
		public int					qIdx			= -1;
		public float				rAmplitude;
		public int					rIdx			= -1;
		public float				sAmplitude;
		public int					sIdx			= -1;
		...
		public float				feat_qra;
		public float				feat_rsa;

		/** area total */
		public float				feat_qrsta;

		/** CC normalized to templates */
		public float				feat_cct1;
		public float				feat_cct2;

		/** ArDiff to templates */
		public float				feat_arT1diff;
		public float				feat_arT2diff;
		...
		private transient float	_x, _y, _sumx, _sumy;
		...
		private transient float	_cc, _maxcc;
		private transient int		_n;


		public float maxCorr (QRS other)
		{
			_maxcc = 0f;
			...
			for (_n = -8; _n < 8; ++_n)
			{
				...
				if (_cc != 0)
				{
					_cc = (float) (_cc / (Math.sqrt( _sumx * _sumy )));
					if (_cc > _maxcc)
						_maxcc = _cc;
				}
			}
		...
		public float arDiff (QRS other)
		{
			if (other.feat_qrsta == 0f)
				return 0f;
	...
	public static class StepHistory
	{
		...
		public float			peakOverall	= 0f;
		public MeanFilter		peakAverage	= new MeanFilter( 8 );
		public float			peakSignal	= 0f;
		public float			peakNoise	= 0f;
		public float			threshold1	= 0f;
		public float			threshold2	= 0f;
	...
	public float				wndIntCompensation	= 0.85f;
	...
	public PanTompkins (int samplingRateInHz)
	{
		...
		wndLength = (int) (150f * samplingRate / 1000f);

		preSegment = (int) (120f * samplingRate / 1000f);
		postSegment = (int) (280f * samplingRate / 1000f);
		...
		mean = new MeanFilter( (int) (350f * samplingRate / 1000f) );
	 ...
	 * @return
	 */
	public float next (float xnow, long timestamp)
	{
		// cancel dc component
